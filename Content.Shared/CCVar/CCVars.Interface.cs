...
public sealed partial class CCVars
{
    ...
    public static readonly CVarDef<string> UIClickSound =
        CVarDef.Create("interface.click_sound", "/Audio/_Dumont/UserInterface/button_click.ogg", CVar.REPLICATED); // Dumont

    /// <summary>
    /// The sound played when the mouse hovers over a clickable UI element
    /// </summary>
    public static readonly CVarDef<string> UIHoverSound =
        CVarDef.Create("interface.hover_sound", "/Audio/_Dumont/UserInterface/button_hover.ogg", CVar.REPLICATED); // Dumont
