...
war-declarator-default-message = Um grupo terrorista conhecido declarou sua intenção de destruir completamente a estação com um dispositivo nuclear e desafia a tripulação a tentar detê-los.
